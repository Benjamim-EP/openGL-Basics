...
window.onload = function init() {
    ...
    gl = WebGLUtils.setupWebGL( canvas ); // Recupere e vincule uma referência ao contexto WebGL à área de desenho
    if ( !gl ) { alert( "WebGL isn't available" ); }
    
    gl.viewport( 0, 0, canvas.width, canvas.height );
    gl.clearColor( 0.8, 0.8, 0.8, 1.0 ); //Limpe a área de desenho da tela para sua cor favorita através do WebGL
    gl.clear( gl.COLOR_BUFFER_BIT ); // resetar as cores
